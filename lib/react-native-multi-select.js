...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    selectedItemTextBackgroundColor: PropTypes.string,
    ...
    hideSelectedItemIcon: PropTypes.bool,
  ...
  static defaultProps = {
    ...
    selectedItemTextBackgroundColor: null,
    searchable: false,
  ...
  dismissSelector = () => this._clearSelector();
  ...
  _submitSelection = (event) => {
    this._toggleSelector(event);
    // reset searchTerm
  ...
  _getRow = item => {
    const {
      ...
      selectedItemTextColor,
      selectedItemTextBackgroundColor
    } = this.props;
    return (
      <View
        onTouchEnd={(event) => item.disabled ? null : this._toggleItem(event, item)}
        style={[
      ...
      >
        <View>
          <View style={[
              ...
              this._itemSelected(item) && selectedItemTextBackgroundColor && {
                borderRadius: 8,
                backgroundColor: selectedItemTextBackgroundColor
              },
          ]}>
            <Text
              style={[
            ...
            {this._itemSelected(item) && !hideSelectedItemIcon ? (
              <Icon
                name="check"
                style={{
                  fontSize: 20,
  ...
  _getRowNew = item => (
    <View
      onTouchEnd={() => item.disabled ? null : this._addItem(item)}
        ...
        {selector ? (
          ...
          >
            ...
            >
              ...
              />
              {hideSubmitButton && (
                <View onTouchEnd={this._submitSelection}>
                  <Icon
                    name="menu-down"
                    style={[
                      styles.indicator,
            ...
            >
              ...
              >
                <View
                  ...
                  onTouchEnd={this._toggleSelector}
                >
                  <Text
                    style={
